...
export class QueryContext {
    ...
    async search(query, options = {}) {
        const { limit = 10, includeEntities = true, includeRelationships = true, includeEpisodes = true, } = options;
        const result = {
            entities: [],
            relationships: [],
            episodes: [],
    ...
    async getEntityContext(entityName) {
        ...
        const relatedEpisodes = allEpisodes.filter(e => e.content.toLowerCase().includes(entityName.toLowerCase()) ||
